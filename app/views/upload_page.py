...
def format_with_ai(text: str) -> str:
    ...
    try:
        prompt = ChatPromptTemplate.from_messages([
            ("system", """Você é um agente especializado do Instituto de Pesquisa Econômica Aplicada (IPEA), com profundo conhecimento sobre estudos socioeconômicos, políticas públicas, desenvolvimento econômico,
            mercado de trabalho, ciência política, dados estatísticos e análise de indicadores sociais,
            Sua missão é fornecer respostas claras, técnicas e sobre qualquer assunto relacionado ao IPEA.
